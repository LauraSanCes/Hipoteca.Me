...
public class DownloadTaskDates extends AsyncTask<String, Void, Void>
{

    static String respuestaResponseDates;
    ...
    protected Void doInBackground(String... endPoint)
    {
        ...
        try
        {
            ...
            respuestaResponseDates = (String) json.get("text");
        }
